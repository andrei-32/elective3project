...
class EmailService {
  ...
  static const String _gmailAppPassword =
      'rqknisdlklakdhih'; // Generate from Google Account
  ...
  static Future<Map<String, dynamic>> sendPasswordResetEmail(
    ...
    try {
      ...
      if (_gmailAddress.contains('your-email') ||
          _gmailAppPassword.contains('your-16-character')) {
      ...
      return {
        'success': false,
        'error':
            'Failed to send email: $e. Please check your email configuration.',
      };
    }
  }
